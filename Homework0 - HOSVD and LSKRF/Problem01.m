...
for ebno = ebnoVec
    ...
    for ii = 1:5e3
        ...
        [X1kX2hat , X3hat] = LSkronF(Y, size(X1kX2,1), size(X1kX2,2),size(X3,1),...
                            size(X3,2), X1kX2(1,1), X3(1,1));
        [X1hat, X2hat] = LSkronF(X1kX2hat, size(X1,1), size(X1,2),size(X2,1),...
                            size(X2,2), X1(1,1), X2(1,1));
